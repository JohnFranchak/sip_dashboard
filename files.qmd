...
ds_files$POS4 <- map2_int(ids, sessions, ~ file.exists(str_glue("{study_dir}data_processed/imu/{.x}_{.y}/infant_position_predictions_4s.csv")))
ds_files$REST4 <- map2_int(ids, sessions, ~ file.exists(str_glue("{study_dir}data_processed/imu/{.x}_{.y}/infant_restrained_predictions_4s.csv")))
