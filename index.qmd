...
| The dataset contains `r length(unique(ds$ID))` unique participants with `r sum(ds$Total)` overall sessions. `r sum(as.numeric(ds$Total == 3))` participants have 3 complete sessions.
